	...
	<div id="sitediv">
		...
		<div id="content">
			...
			<form id="form_verwaltung" action="" method="GET">
				...
				<input id="speichern_button"type="submit" name="laden_button_klasse_bearbeiten" value="Laden"/>
			</form>
			...
			<?php
				if(isset($_GET['klasse']))
				{
					...
					echo "Bezeichnung:*			<input  id='bezeichnung' type='text' name='bezeichnung' value='".$row['class_name']."'/></br>";
					echo "Anzahl Schüler:*		<input id='anzahl_schueler' type='text' name='anzahl_schueler' value='".$row['number_of_students']."'/></br>";
					echo "Schule:*				<input id='schule' type='text' name='schule' value='".$row['school']."'/></br>";
					echo "Ort:*					<input id='ort_klasse' type='text' name='ort_klasse' value='".$row['place']."'/></br>";

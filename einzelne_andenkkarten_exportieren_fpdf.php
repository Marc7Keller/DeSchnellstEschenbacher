...
if(!isset($_POST['participant_id']))
{
	...
	{	 
		$sql= "SELECT * FROM `laptimes` inner join `participants` on fs_participant = participant_id inner join person on fs_person = person_id where fs_event = ".$_SESSION['event']." and participant_id = ".$_POST['participant_id']." order by first_lap asc";

	...
	<div id="sitediv">
		...
		<div id="content">
			...
			<form id="form_verwaltung" action="neue_lehrperson.php" method="POST">				
				Nachname:*				<input  id="nachname_neu" type="text" name="name"/></br>
				Vorname:*				<input id="vorname_neu" class="form_cells" type="text" name="vorname"/></br>
				Strasse:				<input id="strasse_neu" class="form_cells" type="text" name="strasse"/></br>
				PLZ:					<input id="plz_neu" class="form_cells" type="text" name="plz"/></br>
				Ort:					<input id="ort_neu" class="form_cells" type="text" name="ort"/></br></br>
